...
\vspace{8pt}
Найквист и кривая Попова: критерии выполняются
\end{frame}
...
\vspace{8pt}
\begin{itemize}
    \item \textbf{Верхний ряд}: $\varphi(\sigma)=\mathrm{sat}(\sigma)\in[0,1]$ --- \textbf{устойчиво}
    \item \textbf{Нижний ряд}: $\varphi(\sigma)=3\sigma$ (нарушает сектор $[0,1]$) --- \textbf{нестабильно}
\end{itemize}
\end{frame}
