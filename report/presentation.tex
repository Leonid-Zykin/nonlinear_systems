...
\author{Зыкин Л. В., Алёхова М. С., Кисиков Д. С.}
...
\begin{frame}
\frametitle{Секторные ограничения (иллюстрация)}
\centering
\includegraphics[width=0.8\textwidth]{images/sector_constraints.png}
\end{frame}
...
\textbf{Линейная часть}: $G(s) = \dfrac{1}{(s+1)(s+2)}$
...
\centering
\includegraphics[width=0.7\textwidth]{images/nyquist_popov.png}
\vspace{5pt}
\small Найквист и кривая Попова: критерии выполняются
\end{frame}

\begin{frame}
\frametitle{Сравнение: устойчивость vs нестабильность}
\centering
\includegraphics[width=0.45\textwidth]{images/time_response.png}
\vspace{5pt}
\small \textbf{Верхний ряд}: $\varphi(\sigma)=\mathrm{sat}(\sigma)\in[0,1]$ --- \textbf{устойчиво} \\
\textbf{Нижний ряд}: $\varphi(\sigma)=3\sigma$ (нарушает сектор $[0,1]$) --- \textbf{нестабильно}
\end{frame}
